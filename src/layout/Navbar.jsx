...
const Navbar = () => {
  ...
  return (
    <nav className="top-0 left-0 px-[22px] font-mono w-full h-[40px] bg-[#171717] backdrop-blur-md text-white border-b border-[#2D2D2D]  z-50 flex items-center justify-start space-x-[15px]">
      <div className="flex w-[30px] items-center space-x-[10px]">
        <img src={logo} alt="logo-of-university" />
      </div>
      <div className="flex space-x-[5px]" ref={dropdownRef}>
        <div className="relative">
          <button
            className="bg- hover:bg-[#3B3B3B] text-white py-[2px] px-[10px] rounded transition"
